...
public final class FileSender {
  ...
  static final String HOST = System.getProperty("host", "192.168.0.1");
    ...
    ArrayList<EpollEventLoopGroup> EpollEventLoopGroupList;
...
*/
    ...
    public FileSender() {
        ...
        EpollEventLoopGroupList = new ArrayList<EpollEventLoopGroup>();
        myParallelNum = 1;
        myConcurrencyNum = 1;
...
//////////////////////////////////////////
    ...
    public static void registerChannelCtx(String aPathAliasName, FileSenderControlChannelHandler aFileSenderControlChannelHandler, ChannelHandlerContext aChannelCtx, int aChannelType, int aControlChannelId, int aDataChannelId, FileSenderDataChannelHandler aFileSenderDataChannelHandler, long aThreadId, int aParallelNum){
        try {
        ...
        try {//////////////////////////////
            ...
            */
            ...
            for (FileSender.TempPathObject aTempPathObject: FileSender.tempPathList) {
                ...
                //Configure the File Sender (Each Path will have it's own EpollEventLoopGroup
                //EventLoopGroup group = new EpollEventLoopGroup();
                EpollEventLoopGroup group = new EpollEventLoopGroup();
                //Add Event Loop Group to List
                EpollEventLoopGroupList.add(group);
                ...
                for (int i = 0; i < aTempPathObject.getConcurrencyNum(); i++) {
                    ...
                    for (int j = 0; j < aTempPathObject.getParallelNum(); j++) {
                        ...
                        b1.group(group)
                                .channel(EpollSocketChannel.class)
                                //.option(ChannelOption.TCP_NODELAY, true)
                                //.handler(new FileSenderInitializerForDataChannel(NonIoGroup,aTempPathObject.getIpAddressWithoutSrc(),aTempPathObject.getAliasPathName(), DATA_CHANNEL_TYPE, controlChannelId, dataChannelId, this, aTempPathObject.getConcurrencyNum(), aTempPathObject.getParallelNum()));
            ...
            for (EventLoopGroup anEventLoopGroup : EpollEventLoopGroupList) {
                anEventLoopGroup.shutdownGracefully();
            }
            logger.info("All EpollEventLoopGroups were shut down gracefully");
        }
    }
