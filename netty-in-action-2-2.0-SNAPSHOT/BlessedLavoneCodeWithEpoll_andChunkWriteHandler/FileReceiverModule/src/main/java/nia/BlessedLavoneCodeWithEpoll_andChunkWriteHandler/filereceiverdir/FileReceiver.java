...
package nia.BlessedLavoneCodeWithEpoll_andChunkWriteHandler.filereceiverdir;
      ...
      //ServerHandlerHelper myServerHandlerHelper = new ServerHandlerHelper();
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
             ...
             .childOption(EpollChannelOption.AUTO_READ, true)
             .childOption(EpollChannelOption.SO_RCVBUF, 100 * 1024 * 1024) //Socket Receiver Buffer Size 100MB
