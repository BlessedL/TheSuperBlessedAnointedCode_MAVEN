...
*/
   ...
   public static void registerConnectionAckWithPathDoneObject(String anAliasPathName) {
       try {
           //Find the PathDoneObject with this path Alias String
           boolean found = false;
           if (anAliasPathName != null) {
   ...
   public static boolean didAllControlChannelsReceiveConnectionAck() {
    ...
    private class Connector implements Runnable {
        ...
        String thePathInIpAddressFormatWithoutSrc, theAliasPathString;
        int theChannelType, theControlChannelId, theDataChannelId, theConcurrencyNum, theParallelNum, thePipelineNum;
        FileSender theFileSender;
        ...
        Connector(String aPathInIpAddressFormatWithoutSrc, String anAliasPathString, int aChannelType, int aControlChannelId, int aDataChannelId, FileSender aFileSender, int aConcurrencyNum, int aParallelNum, int aPipelineNum, SocketChannel aSocketChannel, SelectionKey aSelectionKey) throws IOException {
            ...
            if (theChannelType == CONTROL_CHANNEL_TYPE){
                logger.info("Connector Constructor: For Control Channel ");
            } else {
                logger.info("Connector Constructor: For Data Channel ");
            }
            theControlChannelId = aControlChannelId;
            theDataChannelId = aDataChannelId;
            theFileSender = aFileSender;
            theConcurrencyNum = aConcurrencyNum;
            theParallelNum = aParallelNum;
            thePipelineNum = aPipelineNum;
            theSocketChannel = aSocketChannel;
        }

        public void run() {
            try {
                boolean socketConnected = theSocketChannel.finishConnect();
                if (socketConnected) {
                    if (theChannelType == CONTROL_CHANNEL_TYPE) {
    ...
    public static class DataChannelObject{
        ...
        public DataChannelObject(int aDataChannelId){
        ...
        public DataChannelObject(int aDataChannelId, long aThreadId){
            myDataChannelId = aDataChannelId;
            connectMsgReceived = false;
            myFileSenderDataChannelHandler = null;
        ...
        public DataChannelObject(int aDataChannelId,  FileSenderDataChannelHandler aFileSenderDataChannelHandler){
            myDataChannelId = aDataChannelId;
            connectMsgReceived = false;
        ...
        public DataChannelObject(int aDataChannelId, FileSenderDataChannelHandler aFileSenderDataChannelHandler, long aThreadId){
            myDataChannelId = aDataChannelId;
            connectMsgReceived = false;
            myFileSenderDataChannelHandler = aFileSenderDataChannelHandler;
            myThreadId = aThreadId;
    ...
    public static class ControlChannelObject{
        ...
        public ControlChannelObject(int aControlChannelId, FileSenderControlChannelHandler aFileSenderControlChannelHandler,  List<DataChannelObject> aDataChannelList ){
        ...
        public ControlChannelObject(int aControlChannelId, List<DataChannelObject> aDataChannelList ){
            myControlChannelId = aControlChannelId;
            myDataChannelList = aDataChannelList;
            connectAckMsgReceived = false;
            myDataChannelList = new ArrayList<FileSender.DataChannelObject>();
        ...
        public ControlChannelObject(int aControlChannelId){
            myControlChannelId = aControlChannelId;
        ...
        public ControlChannelObject(int aControlChannelId, FileSenderControlChannelHandler aFileSenderControlChannelHandler, int aDataChannelId, int aChannelType){
            myControlChannelId = aControlChannelId;
            connectAckMsgReceived = false;
            myStartTimeSet = false;
            myEndTimeSet = false;
            ...
            if (aChannelType == CONTROL_CHANNEL_TYPE) {
                ...
                if (myDataChannelList == null) {
                    //Data Channel List for this Control Channel is EMPTY
                    myDataChannelList = new LinkedList<FileSender.DataChannelObject>();
                    myDataChannelList.add(new FileSender.DataChannelObject(aDataChannelId));
                }
                else {
...
//////////////////////////////////////////
    ...
    public static void registerChannelCtx(String aPathAliasName, FileSenderControlChannelHandler aFileSenderControlChannelHandler,  int aChannelType, int aControlChannelId, int aDataChannelId, FileSenderDataChannelHandler aFileSenderDataChannelHandler, long aThreadId, int aParallelNum){
        try {
            ...
            if ( aPathAliasName != null) {
                ...
                if (!myControlChannelObjectMap.containsKey( String.valueOf(aControlChannelId) ) ) {
                    ...
                    if (aChannelType == CONTROL_CHANNEL_TYPE) {
                        ...
                        myControlChannelObject.addDataChannelObject(new FileSender.DataChannelObject(aDataChannelId, aFileSenderDataChannelHandler, aThreadId));
                    }
                }
            }
    ...
    public static String registeredChannelsToString(){
        try {
    ...
    */
    ...
    public static void registerConnectionAck(String aPathAliasName, int aControlChannelId){
        try {
            //String myCurrentRegisteredChannels = FileSender.registeredChannelsToString();
